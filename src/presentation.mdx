...
<video autoPlay={true} loop={true} muted style={{width: '100vw', height: '100vh' }}>
...
<Reference href="https://www.youtube.com/watch?v=1tavDv5hXpo">The state of animation in React</Reference>
...
<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/66774554c5cee5c22c57b0950c06ded0d36da720" style={{ width: '50vw'}} />

The force is proportional to the extension

<Reference href="https://en.wikipedia.org/wiki/Hooke%27s_law#For_linear_springs">Hooke's law Wikipedia</Reference>
...
<Reference href="https://en.wikipedia.org/wiki/Damping_ratio#Example:_mass.E2.80.93spring.E2.80.93damper">Dumping Force Wikipedia</Reference>

---

### Spring Physics

<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/7a4675e822d9c82d0e6a9443252d9b243970f4a4" style={{ width: '50vw'}} />

<Reference href="https://en.wikipedia.org/wiki/Harmonic_oscillator#Damped_harmonic_oscillator">Harmonic Oscillator Wikipedia</Reference>
...
<Reference href="https://www.react-spring.io/docs/hooks/api">React Spring Api</Reference>
